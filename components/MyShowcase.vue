...
export default {
  ...
  data () {
    return {
      projects: [
        ...
        { key: 'timesales', name: 'Timesales', description: 'A chatbot shop system build with Nuxtjs, Stripe and the Strapi CMS.', imageUrl: 'timesales.png' },
  ...
  computed: {
    selectedProjectImageUrl () {
      return this.projects.find(url => url.name === this.selectedProject).imageUrl
    }
  }
}
</script>
